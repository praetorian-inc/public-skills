...
See [Calculation Methods](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/calculation-methods.md) for detailed formulas.
...
- **[Calculation Methods](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/calculation-methods.md)** - Formulas, graph-based analysis, worked examples
- **[Industry Thresholds](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/thresholds.md)** - McCabe, NIST, Microsoft, NASA standards
- **[Measurement Tools](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/tools.md)** - Language-specific analyzers and CI/CD integration

### Refactoring Techniques

- **[Refactoring Patterns](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/refactoring-patterns.md)** - Extract Method, Guard Clauses, Strategy Pattern, Simplify Boolean Logic
- **[More Refactoring Patterns](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/refactoring-patterns-more.md)** - Lookup Tables, Decompose Conditional, Replace Nested Conditionals with Polymorphism
- **[Refactoring Anti-Patterns](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/refactoring-anti-patterns.md)** - When not to extract
- **[TypeScript Examples](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/typescript-before-after.md)** - Real-world refactorings
- **[Go Examples](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/go-before-after.md)** - Handler and service patterns
- **[Python Examples](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/python-before-after.md)** - Function refactorings

### Advanced Topics

- **[Limitations](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/limitations.md)** - When cyclomatic complexity misleads
- **[Complementary Metrics](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/complementary-metrics.md)** - Cognitive complexity, nesting depth, LOC
...
See [Measurement Tools](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/tools.md) for detailed setup and CI/CD integration.
...
See [Refactoring Patterns](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/refactoring-patterns.md) for detailed techniques with examples.
...
See [Complementary Metrics](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/complementary-metrics.md) for the complete quality model.
...
See [Limitations](../../../.gemini/skills/analyzing-cyclomatic-complexity/references/limitations.md) for detailed discussion.
