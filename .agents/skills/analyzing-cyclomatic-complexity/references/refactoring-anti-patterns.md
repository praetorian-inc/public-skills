...
Part of the [Refactoring Patterns](../../../../.gemini/skills/analyzing-cyclomatic-complexity/references/refactoring-patterns.md) reference — when refactoring hurts more than it helps.
