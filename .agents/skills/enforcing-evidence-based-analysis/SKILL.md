...
**DO NOT skip this skill.** See [Why This Matters](../../../.gemini/skills/enforcing-evidence-based-analysis/references/why-this-matters.md).
...
**See:** [Complete Protocol](../../../.gemini/skills/enforcing-evidence-based-analysis/references/protocol.md) for detailed steps, examples, and documentation format.
...
**See:** [Complete Anti-Hallucination Rules](../../../.gemini/skills/enforcing-evidence-based-analysis/references/anti-hallucination-rules.md)
...
**See:** [Why This Matters](../../../.gemini/skills/enforcing-evidence-based-analysis/references/why-this-matters.md) for the real cost of skipping verification and the verification checklist.
...
**See:** [Complete Rationalization Table](../../../.gemini/skills/enforcing-evidence-based-analysis/references/rationalizations.md) for the full list and why each fails.

---

## Integration

For detailed workflow integration (planning, TDD, debugging), see [Integration with Other Skills](../../../.gemini/skills/enforcing-evidence-based-analysis/references/integration.md).
