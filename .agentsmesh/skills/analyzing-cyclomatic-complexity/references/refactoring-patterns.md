...
- [More Refactoring Patterns](refactoring-patterns-more.md) — Patterns 5–7 (Lookup Tables, Decompose Conditional, Replace Nested Conditionals with Polymorphism)
- [Refactoring Anti-Patterns](refactoring-anti-patterns.md) — when extracting hurts more than it helps
